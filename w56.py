...
def w56_download_by_id(id, title=None, output_dir='.', stream_type=None):
	...
	download_urls([url], title, str(ext), total_size=size)

def w56_download(url):
	id = r1(r'http://www.56.com/u\d+/v_(\w+).html', url)
	w56_download_by_id(id)
